...
# Load Data
temp_data = pd.read_csv(DATA / 'Temperature_Data_Manjimup.csv')
rainfall_data = pd.read_csv(DATA / 'Rainfall_Data_Manjimup.csv')
soil_data = pd.read_csv(DATA / 'Soil_Parameters.csv')
crop_data = pd.read_csv(DATA / 'Crop_Parameters_Southwest.csv')
irrigation_data = pd.read_csv(DATA / 'Irrigation_Parameters.csv')

# Filter soil data for Southwest (Manjimup)
soil_data = soil_data[soil_data['Region'] == 'Manjimup']
...
# Crop_Parameters_Southwest.csv is not one of this region's soil types in
